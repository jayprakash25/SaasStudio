        ...
        <div className="bg-[#222222] w-screen overflow-x-clip">
            ...
            <div className="flex flex-col max-w-md px-6 mx-auto text-white md:max-w-7xl md:justify-between md:flex-row">
              ...
              <div className="mt-5 space-y-5 md:max-w-2xl">
                <p className="font-semibold md:text-2xl">
                  We are a website agency covering high-level Design,
                  Development, and SEO.
                </p>
                <p className="font-semibold md:text-2xl">
                  Our website packages are diverse from stunning landing pages
                  to complex website apps.
                </p>
              </div>
            </div>
          </div>
          ...
          <footer className="pb-10 overflow-hidden">
            <div className="flex animate-marquee whitespace-nowrap">
              ...
              <h1 className="text-6xl font-bold text-white md:text-9xl">
                SAAS STUDIOS INDIA
              </h1>
            </div>
